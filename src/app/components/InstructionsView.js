...
export default function InstructionsView({ onStartQuiz }) {
  ...
  return (
    <div className="z-10 flex flex-col items-center justify-center p-4 text-center">
      <h1 className="mb-4 text-7xl font-bold tracking-tight">Instructions</h1>
      <div className="mb-8 max-w-2xl text-lg text-gray-300">
        <p className="mb-4 text-2xl">
          Welcome to the quiz! Here are the rules:
        </p>
        <ul className="space-y-3 text-left text-2xl">
      ...
      <Button
        onClick={onStartQuiz}
        className="w-48 transform rounded-full bg-brand-primary px-8 py-4 text-2xl font-semibold text-black transition active:scale-95 active:bg-brand-primary/90"
      >
        Start Quiz
      </Button>
    </div>
